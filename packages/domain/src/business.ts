...
export const businessErrorCodes = [
  ...
  "ORGANIZATION_VERIFICATION_STALE",
  "ORGANIZATION_VERIFICATION_INVALID",
  "PROFILE_STALE",
  "FIELD_INVALID",
  ...
  "SUPPLIER_INELIGIBLE",
  "EXPORTER_INVITATION_INVALID",
  "EXPORTER_INVITATION_EXPIRED",
  "EXPORTER_INVITATION_REVOKED",
  "EXPORTER_INVITATION_USED",
  ...
  "ORDER_NOT_AWAITING_DECISION",
  "ORDER_DECISION_EXPIRED",
  "ORDER_ALREADY_DECIDED",
  "ORDER_REVISION_MISMATCH",
  "ORDER_TERMS_HASH_MISMATCH",
  "TRADE_TERMS_INCOMPLETE",
  "TRADE_TERMS_INVALID",
  "TRADE_ORDER_LEGACY_INCOMPLETE",
  "TRADE_ORDER_REACCEPTANCE_REQUIRED",
  "ORDER_CANNOT_REVISE",
  "ORDER_DECISION_REASON_INVALID",
  "AMOUNT_INVALID",
  "AMOUNT_OVERFLOW",
  "TOTAL_MISMATCH",
  "ASSET_UNSUPPORTED",
  "IDEMPOTENCY_CONFLICT",
  "TRADE_DOCUMENT_FORBIDDEN",
  "TRADE_DOCUMENT_INVALID",
  "TRADE_DOCUMENT_STALE",
  "SHIPMENT_INVALID",
  "SHIPMENT_STALE",
  "INTERNAL_ERROR",
] as const;
